...
'''we can also pass a list , tuple or 
any array like object with array(). 
...
'''Dimensions in Arrays - a dimensions 
in arrays is one level of array depth(nested array)
...
''' 1-D arrays - an array that has 0-D arrays 
as its elements is called uni directional or 1 -D'''
import numpy as np
sanjay = np.array([1, 2, 3, 4, 5])
print(sanjay)
...
import numpy as np
sanjay = np.array([[[1, 2, 3], [4, 5, 6]], [[1, 2, 3],[4, 5, 6]]])
print(sanjay)
...
import numpy as np
sanjay = np.array([1, 2, 3, 4, 5], ndmin = 5)
print(sanjay)
print('number of dimesions: ', sanjay.ndim)
